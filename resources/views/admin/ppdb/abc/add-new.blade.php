                ...
                <form id="formPpdb">
                    ...
                    <div class="row gx-3">
                        <div class="mb-3 col-md-4">
                            ...
                            <select class="form-control" id="kelas_sebelum" name="kelas_sebelum">
                        ...
                        <div class="mb-3 col-md-4" id="div_smt_kelas_sebelum">
                            ...
                            <select class="form-control" id="smt_kelas_sebelum" name="smt_kelas_sebelum">
                        ...
                        <div class="mb-3 col-md-4" id="div_tipe_kelas_sebelum">
                            ...
                            <select class="form-control" id="tipe_kelas_sebelum" name="tipe_kelas_sebelum">
                    ...
                    <div class="row gx-3">
                        ...
                        <div class="mb-3 col-md-4" id="kelas_wrapper">
                        ...
                        <div class="mb-3 col-md-4">
                            ...
                            <select class="form-control" id="paket_spp_id" name="paket_spp_id" style="width: 100%;"></select>
                        </div>
                        <div class="mb-3 col-md-4">
                        ...
                        <div class="mb-3 col-md-4">
                            ...
                            <input class="form-control" id="tahun_lulus" name="tahun_lulus" type="text" placeholder="ex. 2018" value="" />
                        </div>
                        <br>
                    ...
                    <div class="row gx-3">
                        <div class="mb-3 col-md-2">
                            ...
                            <br>
                            <label>
                                <input type="file" class="d-none" id="bukti_tf_file" name="bukti_tf_file" accept="image/png, image/jpg, image/jpeg" required>
    ...
    $(document).ready(function() {
        ...
        validatorPpdb = $("#formPpdb").validate({
            ...
            rules: {
                ...
                kelas: {
                    required: function() {
                        // Lakukan pengecekan kondisi di sini
                        return $('#layanan_kelas_id').val() != 4 ? true : false;
                    }
                },
                smt_kelas: {
                    required: true
        ...
        */
        ...
        $("#layanan_kelas_id").on("change", function(e) {
            ...
            if (layananKelasSelected == 4) {
                $('#kelas_wrapper').hide();
                getSemesterKelasKhususOptions(function(output) {
                    $("#smt_kelas").html(output);
                });
        ...
        $("#paket_spp_id").on("change", function(e) {
            ...
            getPaketSppDetail(paketSppSelected, function(output){
                ...
                */
                ...
                // menampilkan pilihan kelas khusus jika paket spp include kelas khusus
        ...
        $('#submitPpdbBtn').on('click', function(e){
            ...
            formData.append('nis', $('#formPpdb').find('#nis').val());
            ...
            formData.append('kelas_sebelum', $('#formPpdb').find('#kelas_sebelum').val());
            ...
            formData.append('bayar_kk', $('#formPpdb').find('#bayar_kelas_khusus').val());
                ...
                success: function(res) {
                    ...
                    if (!res.error) {
                        ...
                        swalSuccess({
                            ...
                            withRedirect: true,
                            redirectUrl: '{{route("web.su.ppdb.abc.list")}}'
                        });
                        // resetForm();
                    }else{
                        // showError('failed');
                        swalError({text: 'Pendafataran Gagal'});
                    }
                },
