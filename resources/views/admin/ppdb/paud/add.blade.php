                ...
                <div class="row align-items-center justify-content-between pt-3">
                    <div class="col-auto mb-3">
                        <h1 class="page-header-title">
                            ...
                            <span id="page-header-title-text">Add PPDB PAUD</span>
                        </h1>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        if (id != null && id != '') {
            $('#page-header-title-text').text("Edit PPDB PAUD");
                            ...
                            tbody += ""+
                                "<tr>"+
                                    ...
                                    "<td>"+
                                        ...
                                        " <a target='_blank' class='btn btn-sm btn-info' href='"+row.url_bukti_trf+"'>Bukti Transfer</a>";
                                    "</td>"+
                                "</tr>";
                        });
