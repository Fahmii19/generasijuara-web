                ...
                <div class="row align-items-center justify-content-between pt-3">
                    <div class="col-auto mb-3">
                        <h1 class="page-header-title">
                            ...
                            Daftar Ulang - Paket ABC
                        </h1>
                    </div>
                    <div class="col-12 col-xl-auto mb-3">
                        <!-- <a class="btn btn-sm btn-light text-primary" href="{{route('web.su.ppdb_ulang.abc.add')}}">
        ...
        table = $('#dtPPDBUlang').DataTable({
            ...
            columns:[
                ...
                },
                {
                    ...
                    "searchable"    : false,
                    render  : function (data,type, row){
                        return '<a href="{{route('web.su.ppdb_ulang.abc.edit')}}/'+row.id+'" class="editPPDB btn btn-sm btn-transparent-dark"><i class="fas fa-edit"></i></a>'
