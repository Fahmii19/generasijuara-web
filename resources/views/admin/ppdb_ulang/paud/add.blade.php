                ...
                <div class="row align-items-center justify-content-between pt-3">
                    <div class="col-auto mb-3">
                        <h1 class="page-header-title">
                            ...
                            <span id="page-header-title-text">Add Daftar Ulang PAUD</span>
                        </h1>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        if (id != null && id != '') {
            $('#page-header-title-text').text("Edit Daftar Ulang PAUD");
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    if (!res.error) {
                        ...
                        $('#formPpdb').find('#nis').val(res.data.ppdb.nis);
                        $('#formPpdb').find('#nisn').val(res.data.nisn);
                        $('#formPpdb').find('#email').val(res.data.ppdb.email);
                        $('#formPpdb').find('#jenis_kelamin').val(res.data.ppdb.kelamin);
                        $('#formPpdb').find('#nama').val(res.data.ppdb.nama);
                        $('#formPpdb').find('#nama_ayah').val(res.data.ppdb.nama_ayah);
                        $('#formPpdb').find('#nama_ibu').val(res.data.ppdb.nama_ibu);
                        $('#formPpdb').find('#nik_siswa').val(res.data.ppdb.nik_siswa);
                        $('#formPpdb').find('#nik_ayah').val(res.data.ppdb.nik_ayah);
                        $('#formPpdb').find('#nik_ibu').val(res.data.ppdb.nik_ibu);
                        $('#formPpdb').find('#hp_siswa').val(res.data.ppdb.hp_siswa);
                        $('#formPpdb').find('#hp_ayah').val(res.data.ppdb.hp_ayah);
                        $('#formPpdb').find('#hp_ibu').val(res.data.ppdb.hp_ibu);
                        $('#formPpdb').find('#telegram_siswa').val(res.data.ppdb.telegram_siswa);
                        $('#formPpdb').find('#telegram_ayah').val(res.data.ppdb.telegram_ayah);
                        $('#formPpdb').find('#telegram_ibu').val(res.data.ppdb.telegram_ibu);
                        ...
                        $('#formPpdb').find('#paket_kelas_id').val(res.data.paket_kelas.nama);
                        $('#formPpdb').find('#smt_kelas').val(res.data.semester);
                        $('#formPpdb').find('#lulusan').val(res.data.ppdb.lulusan);
                        $('#formPpdb').find('#tahun_lulus').val(res.data.ppdb.tahun_lulus);
                        $('#formPpdb').find('#biaya_daftar').val(res.data.biaya_daftar);
                        $('#formPpdb').find('#biaya_program').val(res.data.biaya_program);
        ...
        $('#submitPpdbBtn').on('click', function(e){
            ...
            var data = {
                ...
                'bayar_daftar' : $('#formPpdb').find('#biaya_daftar').val(),
                'bayar_spp' : $('#formPpdb').find('#biaya_spp').val(),
                'type' : typeSelected,
            }
            console.log('submit', data);
            $.ajax({
                type: "POST",
                url: "{{empty($id) ? route('ajax.ppdb-ulang.create') : route('ajax.ppdb-ulang.update')}}",
                data: data,
                success: function(res) {
