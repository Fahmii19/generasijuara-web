<!DOCTYPE html>
<html>
<link rel="stylesheet" href="{{asset('assets/admin/dist/css/styles.css')}}">
<head>
	<title>Raport</title>
<style type="text/css">
	body {
	...
	<div class="row">
		<div class="col-md-7">
			<table style="width: 70%;">
				<tr>
					...
					<td>: </td>
					<td style="border-bottom:solid 1px #000; padding: 10px;"><b>PKBM GENERASI JUARA </b></td>
				</tr>
				<tr>
		...
		<div class="col-md-3" style="float: right;">
			<table style="width: 100%;">
				<tr>
					<td style="padding: 10px;border-bottom: solid 1px #000;"><b>Paket B Setara SMP </b></td>
				</tr>

				<tr>
					<td style="padding: 10px;border-bottom: solid 1px #000;">Tingkatan/Setara Kls. <b> : 3/VII</b></td>
				</tr>

				<tr>
					<td style="padding: 10px;border-bottom: solid 1px #000;">Paket Kompetensi<b>: 3.1</b></td>
				</tr>

				<tr>
					<td style="padding: 10px;border-bottom: solid 1px #000;">Tahun Pelajaran<b>: 2019/2020</b></td>
				</tr>
			</table>
		</div>
