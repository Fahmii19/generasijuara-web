...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        function exportSusulanRemedial(context) {
            ...
            var parameter = "?kelas_id=" + kelas_id + "&kmp_id=" + mata_pelajaran_id + "&tahun_akademik_id=" + tahun_akademik_id;
            var url = "{{route('web.su.susulan_remedial.export_excel')}}" + parameter;
