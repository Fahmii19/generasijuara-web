                            ...
                            <div class="col-lg-5">
                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="POST" action="{{ route('password.update-siab-password') }}">
                                            @csrf
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input id="nis" type="text" class="form-control @error('nis') is-invalid @enderror" name="nis" value="{{ $nis ?? old('nis') }}" required readonly>
