        ...
        <div class="nav accordion" id="accordionSidenav">
            ...
            <div class="collapse" id="collapseAkademik" data-bs-parent="#accordionSidenav">
                <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavAkademikMenu">
                    <a class="nav-link" href="{{route('web.situ.jadwal_pelajaran.list')}}">Jadwal Pelajaran</a>
                    <a class="nav-link" href="{{route('web.situ.nilai.list')}}">Nilai</a>
                    <a class="nav-link" href="{{route('web.situ.susulan_remedial.list')}}">Susulan & Remedial</a>
                </nav>
            </div>
        </div>
    </div>
