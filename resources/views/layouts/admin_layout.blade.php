    ...
    <body class="nav-fixed">
        ...
        <div id="layoutSidenav">
            <div id="layoutSidenav_nav">
                @if(session()->has('apps'))
                    @if(session()->get('apps') == 'siab')
                        @include('includes.sidebar.siab')
                    @elseif(session()->get('apps') == 'su')
                        @include('includes.sidebar.admin')
                    @elseif(session()->get('apps') == 'situ')
                        @include('includes.sidebar.tutor')
                    @elseif(session()->get('apps') == 'sireka')
                        @include('includes.sidebar.sireka')
                    @elseif(session()->get('apps') == 'sirego' && session()->get('role') == 'AdminKesiswaan')
                        @include('includes.sidebar.sirego_kesiswaan')
                    @elseif(session()->get('apps') == 'sirego' && session()->get('role') == 'AdminAkademik')
                        @include('includes.sidebar.sirego_akademik')
                    @elseif(session()->get('apps') == 'sialum')
                        @include('includes.sidebar.sialum')
                    @endif
                @else
                    @include('includes.sidebar.admin')
                @endif
        ...
        <script type="text/javascript">
            ...
            function getLayananKelasOptions(handleData) {
                $.ajax({
                    ...
                    success: function(res) {
                        ...
                        $.each(res.data, function (i, row) {
                            html_results += "<option value='"+row.id+"'>"+row.kode+" ("+row.nama+")</option>";
                        });
                        handleData(html_results); 
                    }
                });
            ...
            function getPaketKelasWithParamsOptions(params, handleData) {
            ...
            function getMataPelajaranByKelasOptions(kelasId, handleData) {
                $.ajax({
                    ...
                    success: function(res) {
                        ...
                        var html_results = "<option value=''>-- Pilih Mata Pelajaran --</option>";
                        $.each(res.data, function (i, row) {
                            html_results += "<option value='"+row.id+"'>"+row.mata_pelajaran_detail.nama+" | "+row.mata_pelajaran_detail.kelompok+"</option>";
                        });
                        handleData(html_results);
                    }
                });
