                            ...
                            @foreach($types as $kt => $type)
                                ...
                                <div class="row gx-3">
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <input class="form-control nilai-input" id="{{$kt}}_tugas_{{$i}}" type="text" placeholder="" readonly="readonly">
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        <label for="{{$kt}}_ujian_{{$i}}">Ujian Modul</label>
                                        <input class="form-control nilai-input" id="{{$kt}}_ujian_{{$i}}" type="text" placeholder="" readonly="readonly">
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        <label for="{{$kt}}_nilai_{{$i}}">Nilai Akhir</label>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        table = $('#dtSusulanRemedial').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{route('ajax.dt.susulan_remedial.get_siswa')}}",
                type: "POST",
                dataType: "json",
                data: function(d) {
                    d._token = "{{ csrf_token() }}",
                ...
                success: function(res) {
                    ...
                    if (!res.error) {
                        ...
                        if (res.data?.susulan_remedial != null) {
                            $('#formSusulanRemedial').find('#p_tugas_1').val(res.data?.p_tugas_1);
                            $('#formSusulanRemedial').find('#p_ujian_1').val(res.data?.p_ujian_1);
                            $('#formSusulanRemedial').find('#p_nilai_1').val(res.data?.p_nilai_1);
                            $('#formSusulanRemedial').find('#p_predikat_1').val(res.data?.p_predikat_1);
                            $('#formSusulanRemedial').find('#k_tugas_1').val(res.data?.k_nilai_1);
                            $('#formSusulanRemedial').find('#k_nilai_1').val(res.data?.k_nilai_1);
                            $('#formSusulanRemedial').find('#k_predikat_1').val(res.data?.k_predikat_1);

                            $('#formSusulanRemedial').find('#p_tugas_2').val(res.data?.p_tugas_2);
                            $('#formSusulanRemedial').find('#p_ujian_2').val(res.data?.p_ujian_2);
                            $('#formSusulanRemedial').find('#p_nilai_2').val(res.data?.p_nilai_2);
                            $('#formSusulanRemedial').find('#p_predikat_2').val(res.data?.p_predikat_2);
                            $('#formSusulanRemedial').find('#k_tugas_2').val(res.data?.k_nilai_2);
                            $('#formSusulanRemedial').find('#k_nilai_2').val(res.data?.k_nilai_2);
                            $('#formSusulanRemedial').find('#k_predikat_2').val(res.data?.k_predikat_2);

                            $('#formSusulanRemedial').find('#p_tugas_3').val(res.data?.p_tugas_3);
                            $('#formSusulanRemedial').find('#p_ujian_3').val(res.data?.p_ujian_3);
                            $('#formSusulanRemedial').find('#p_nilai_3').val(res.data?.p_nilai_3);
                            $('#formSusulanRemedial').find('#p_predikat_3').val(res.data?.p_predikat_3);
                            $('#formSusulanRemedial').find('#k_tugas_3').val(res.data?.k_nilai_3);
                            $('#formSusulanRemedial').find('#k_nilai_3').val(res.data?.k_nilai_3);
                            $('#formSusulanRemedial').find('#k_predikat_3').val(res.data?.k_predikat_3);
